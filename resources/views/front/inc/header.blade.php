...
<head>
    ...
    <title>{{$setts->name}}</title>
    <link rel="icon" href="{{asset("front/img/$setts->favicon")}}">
    <!-- Bootstrap CSS -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="{{route('front.home')}}"> <img src="{{asset("front/img/$setts->logo")}}" alt="logo"> </a>
